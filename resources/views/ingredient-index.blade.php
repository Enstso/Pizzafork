                        ...
                        <tbody>
                            @foreach ($ingredients as $ingredient)
                                <tr>
                                    ...
                                    @else
                                        <td class="col-3"><img src="{{ $ingredient->picture }}" alt=""
                                                class="img-fluid">
                                        </td>
                                    @endif
                                    <td class="col-3">{{ $ingredient->text }}</td>
                                    <td class="col-3">
                                        <a href="/ingredient/edit/{{ $ingredient->id }}" class="btn btn-primary"
                                            role="button">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="/ingredient/delete/{{ $ingredient->id }}" class="btn btn-danger"
                                            role="button">
